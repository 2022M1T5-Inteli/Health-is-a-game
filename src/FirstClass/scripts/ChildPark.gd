...
func _ready():
	...
	$Elements/Ball/Ball2.position = Vector2(rng.randi_range(2470, 2630), rng.randi_range(450,90))
	...
	$Elements/Banana/Banana.position = Vector2(rng.randi_range(1960, 2120), rng.randi_range(450,90))
	$Elements/Banana/Banana2.position = Vector2(rng.randi_range(3150, 3310), rng.randi_range(450,90))
	$Elements/Banana/Banana3.position = Vector2(rng.randi_range(4520, 4680), rng.randi_range(450,90))
	...
	$Elements/GoodSun/GoodSun.position = Vector2(rng.randi_range(2640, 2800), rng.randi_range(450,90))
	$Elements/GoodSun/GoodSun2.position = Vector2(rng.randi_range(5540, 5700), rng.randi_range(450,90))
	...
	$Elements/Chocolate/Chocolate.position = Vector2(rng.randi_range(2130, 2290), rng.randi_range(450,90))
	$Elements/Chocolate/Chocolate2.position = Vector2(rng.randi_range(3320, 3480), rng.randi_range(450,90))
	$Elements/Chocolate/Chocolate3.position = Vector2(rng.randi_range(4690, 4850), rng.randi_range(450,90))
	...
	$Elements/FriedPotatoes/FriedPotatoes2.position = Vector2(rng.randi_range(2810, 2970), rng.randi_range(450,90))
	$Elements/FriedPotatoes/FriedPotatoes3.position = Vector2(rng.randi_range(3830, 3990), rng.randi_range(450,90))
	...
	$Elements/Soda/Soda3.position = Vector2(rng.randi_range(4350, 4510), rng.randi_range(450,90))
	$Elements/Soda/Soda4.position = Vector2(rng.randi_range(5200, 5360), rng.randi_range(450,90))
	$Elements/Soda/Soda5.position = Vector2(rng.randi_range(6050, 6210), rng.randi_range(450,90))
	$Elements/Soda/Soda6.position = Vector2(rng.randi_range(6730, 6890), rng.randi_range(450,90))
	$Elements/Soda/Soda7.position = Vector2(rng.randi_range(7580, 7740), rng.randi_range(450,90))
	$Elements/Soda/Soda8.position = Vector2(rng.randi_range(8090, 8250), rng.randi_range(450,90))
	
	$Elements/BadSun/BadSun.position = Vector2(rng.randi_range(1790, 1950), rng.randi_range(450,90))
	$Elements/BadSun/BadSun2.position = Vector2(rng.randi_range(2980, 3140), rng.randi_range(450,90))
	$Elements/BadSun/BadSun3.position = Vector2(rng.randi_range(4170, 4340), rng.randi_range(450,90))
	$Elements/BadSun/BadSun4.position = Vector2(rng.randi_range(5780, 6040), rng.randi_range(450,90))
